...
```bash
docker run -v $(pwd)/embykeeper:/app --rm -it --net=host ghcr.io/emby-keeper/embykeeper
```
...
```bash
docker pull ghcr.io/emby-keeper/embykeeper
```
...
```bash
docker run -v $(pwd)/embykeeper:/app --rm -it --net=host ghcr.io/emby-keeper/embykeeper:v1.1.1 -i
```
...
```bash
docker run -v $(pwd)/embykeeper:/app --rm -it --net=host ghcr.io/emby-keeper/embykeeper -e
```
...
```bash
docker run -v $(pwd)/embykeeper-src:/src -v $(pwd)/embykeeper:/app --rm -it --net=host ghcr.io/emby-keeper/embykeeper:main-dev -i
```
